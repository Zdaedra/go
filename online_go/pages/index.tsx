...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-[#171412] text-[#E9D7C0] selection:bg-[#d9a35f]/30 font-sans overflow-x-hidden"
            ...
            <main className="pt-12 pb-24 border-t border-white/5 relative z-10 bg-[#171412]">
            ...
            <footer className="border-t border-white/5 bg-[#0A0A0A] py-12">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-2">
                        <img src="/img/kai_logo.png" className="h-16 object-contain opacity-90 mix-blend-multiply" alt="KAI" />
                    </div>
