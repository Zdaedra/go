...
const styles = StyleSheet.create({
  ...
  domainChip: {
    ...
    backgroundColor: '#8A7B65', borderRadius: 999,
    paddingVertical: 4, paddingHorizontal: 12, overflow: 'hidden',
  },
  sessionMeta: { fontSize: 13, color: '#6E6152', fontVariant: ['tabular-nums'] },
  meta: { fontSize: 13, color: '#6E6152' },
  status: { fontSize: 16, fontWeight: '600', minHeight: 24 },
  ok: { color: '#4A6238' },
  bad: { color: '#B23A2B' },
  feedback: { fontSize: 14, color: '#8A5A2B', fontWeight: '600' },
  ...
  doneText: { fontSize: 15, color: '#6E6152', textAlign: 'center', lineHeight: 22 },
});
