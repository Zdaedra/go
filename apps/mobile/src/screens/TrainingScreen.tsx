...
const styles = StyleSheet.create({
  ...
  headerCell: {
    ...
    backgroundColor: '#1A1715', borderRadius: 10,
  },
  big: { fontSize: 20, fontWeight: '800', fontVariant: ['tabular-nums'], color: '#F2EFEA' },
  small: { fontSize: 12, color: '#8E8B85' },
  playBtn: {
    backgroundColor: '#8B7CF6', borderRadius: 12, paddingVertical: 16,
  ...
  barWeak: { backgroundColor: '#8B7CF6' },
