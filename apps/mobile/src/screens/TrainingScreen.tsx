...
const styles = StyleSheet.create({
  ...
  headerCell: {
    ...
    backgroundColor: '#F3EDDF', borderRadius: 10,
  },
  big: { fontSize: 20, fontWeight: '800', fontVariant: ['tabular-nums'] },
  small: { fontSize: 12, color: '#6E6152' },
  playBtn: {
    backgroundColor: '#B23A2B', borderRadius: 12, paddingVertical: 16,
    alignItems: 'center', marginTop: 6,
  },
  playText: { color: '#FFFFFF', fontSize: 18, fontWeight: '800' },
  playNote: { fontSize: 13, color: '#6E6152', textAlign: 'center' },
  section: {
    fontSize: 12, fontWeight: '700', letterSpacing: 1.2,
    textTransform: 'uppercase', color: '#6E6152', marginTop: 10,
  },
  domainRow: { gap: 5 },
  domainHead: { flexDirection: 'row', justifyContent: 'space-between', gap: 8 },
  domainName: { fontSize: 15, fontWeight: '600', flexShrink: 1 },
  domainMeta: { fontSize: 12.5, color: '#6E6152', fontVariant: ['tabular-nums'] },
  barTrack: { height: 6, borderRadius: 3, backgroundColor: '#E0D6C2' },
  barFill: { height: 6, borderRadius: 3, backgroundColor: '#7B9464' },
  barWeak: { backgroundColor: '#B23A2B' },
  poolNote: { fontSize: 12.5, color: '#6E6152', marginTop: 8 },
